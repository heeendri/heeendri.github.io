...
fusionarguments = "/S /execmode=Service /acceptlicense /server='http://172.16.1.78/plugins/fusioninventory/' /runnow" 
' Depending on your needs, you can use either HTTP or Windows share
fusionsetupURL = "http://172.16.1.78/plugins/fusioninventory-agent_windows-x86_" & versionverification & ".exe" 
